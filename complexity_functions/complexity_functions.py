...
def comp_fn_6_1000(n):
    return n**0.5 * max(math.log(n,2),1)
def comp_fn_6_1010(n):
    return n**0.5 * max(math.log(n,2),1) * log_star(n,2)
...
def comp_fn_6_5000(n):
    return n**0.6
def comp_fn_6_6000(n):
    return n**5/8 * ((max(math.log(n,2),1)**2) * max(math.log(max(math.log(n,2),1),2),1))**(3/4)
...
def comp_fn_12_0000(n):
    return n * max(math.log(n,2),1)**2
def comp_fn_12_1000(n):
    return n * max(math.log(n,2),1)**2 * max(math.log(max(math.log(n,2),1),2),1)
...
def comp_fn_25_0200(n):
    return n**(2+2*EPS)
def comp_fn_25_2000(n):
    return n**2.032
def comp_fn_25_3000(n):
    return n**2.214
def comp_fn_25_5000(n):
    return n**(7/3)
def comp_fn_25_5100(n):
    return n**(7/3) * max(math.log(n,2),1)
...
def comp_fn_26_5000(n):
    return n**2.5
def comp_fn_26_5500(n):
    return n**2.5 * math.sqrt(max(math.log(n,2),1))
def comp_fn_26_6000(n):
    return n**2.5 * max(math.log(n,2),1)
def comp_fn_26_6500(n):
    return n**2.5 * max(math.log(n,2),1)**1.5
...
def comp_fn_80_0000(n):
    return n**8
def comp_fn_85_0000(n):
    return n**8 * max(math.log(n,2),1)**5
def comp_fn_90_0000(n):
    return n**9
def comp_fn_92_0000(n):
    return n**9 * max(math.log(n,2),1)**2
def comp_fn_101_0000(n):
    return n**10 * max(math.log(n,2),1)
def comp_fn_400_0000(n):
    return n**16
def comp_fn_500_0000(n):
    #  n**(5 * max(math.log(n,2),1))
    return Huge(2,max(math.log(n,2),1)*(5*max(math.log(n,2),1)))
def comp_fn_600_0000(n):
    # n**(max(math.log(n,2),1)**6 to avoid overflow
    return Huge(2, max(math.log(n,2),1) * max(math.log(n, 2),1)**6)
